...
set title "Duration Period vs Uplink Throughput"
set xlabel "Duration Period (ms)"
set ylabel "Uplink Throughput (kbps)"

plot 'durationPeriodTestUp.dat' using 1:3:2:6:5 with candlesticks lt 4 notitle, \
